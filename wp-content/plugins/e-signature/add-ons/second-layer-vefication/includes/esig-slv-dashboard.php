...
if (!class_exists('Esig_Slv_Dashboard')):
    ...
    class Esig_Slv_Dashboard extends Esig_Slv_Settings {
        ...
        public function esig_verify_access_code() {
            ...
            $email_address = $_POST['esig_email_address'];
            $access_code = $validation->esig_clean($_POST['esig_access_code']);
        ...
        public function slv_set_password() {
            ...
            $validation = new WP_E_Validation();
            $esig_slv_password = $validation->esig_clean($_POST['esig_slv_password']);
            $esig_slv_confirm_password = $validation->esig_clean($_POST['esig_slv_confirm_password']);
        ...
        public function slv_reset_password() {
            ...
            $validation = new WP_E_Validation();
            $esig_slv_reset_address = $validation->esig_clean($_POST['esig_slv_reset_address']);
        ...
        public static function send_password($document_id, $email_address) {
            ...
            $subject = $document->document_title . " - Password by " . $sender;
            
            $message = ' Your Document access password is : '. self::get_slv_password($document_id, $email_address); 
