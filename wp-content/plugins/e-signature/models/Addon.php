...
class WP_E_Addon extends WP_E_Model {
            ...
            foreach ($plugin_list as $plugin) {
                if ($addon_id != $plugin->addon_id) {
                    ...
                    if (version_compare($old_version, $plugin->new_version, '<')) {
                        ...
                        $msg = sprintf(__('WP E-Signature %s %s Updates is available  <a href="admin.php?page=esign-addons" class="esign-addon-update-btn"> Click Here To Update</a>', 'esign'), $plugin->item_name, $plugin->new_version);
    ...
    public static function esig_direct_install($source, $destination) {
        ...
        echo "Trying to install with alternative method...<br>";
        ...
        echo "Install failed. Try to install manually";
    }
