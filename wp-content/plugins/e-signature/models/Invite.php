...
class WP_E_Invite extends WP_E_Model {
    ...
    public function recordSent($invitation_id, $date_sent = null) {
        ...
        $result = $this->wpdb->query(
                $this->wpdb->prepare(
                        ...
                        "WHERE invitation_id=%d", $date_sent, $_SERVER['REMOTE_ADDR'], $invitation_id
                )
        );
    ...
    public function reciepent_list($document_id) {
       ...
       $recipient_emails .= ' <div id="recipient_emails_ajax" class="invitation-emails">';
        ...
        $recipient_emails .='
               ...
               <div class="esig-signer-container">
                    ...
                    <span class="esig-signer-right"> <a href="#" id="standard_view" class="add-signer"> '. __('+ Add Signer', 'esig') .'</a></span>
                    
               </div>';
                $recipient_emails .= apply_filters("esig_cc_users_content", "",$document_id); 
