...
function esig_auto_save_ajax() {
    ...
    if (isset($data['esig_custom_message'])) {
        $api->setting->set('esig_custom_message' . $document_id, $data['esig_custom_message']);
        $api->setting->set('esig_custom_message_text' . $document_id, $data['esig_custom_message_text']);
    }
