    ...
    if ($all_addons_list) {
        ...
        if ($license_key == "no") {
            ...
            <div class="esig-add-on-block esig-pro-pack open">
                ...
                <h3>A Valid E-Signature License is Required</h3>
                <p style="display:block;"> A valid WP E-Signature license is required for access to critical updates and support. Without a license you are putting you and your signers at risk. To protect yourself and your documents please update your license.</p><a href="https://www.approveme.me/#pricingPlans" class="esig-btn-pro" target="_blank"> Purchase a license </a>
            </div>
        ...
        if ($business_pack_option && !Esig_Addons::is_updates_available()) {
            ...
            <div class="esig-add-on-block esig-pro-pack open" id="esig-all_install">
                ...
                <a class="esig-btn-pro" id="esig-install-alladdons" href="<?= $business_pack_option ?>"><?php _e('Install all Add-ons Now', 'esig'); ?></a>
            </div>
        ...
        elseif($business_pack_option && Esig_Addons::is_updates_available()) {?>
             ...
             <div class="esig-add-on-block esig-pro-pack open" id="esig-all_install">
                ...
                <a class="esig-btn-pro" id="esig-install-alladdons" href="<?= $business_pack_option ?>"><?php _e('Update all Add-ons Now', 'esig'); ?></a>
            </div>
          <?php  
        }
        ...
        foreach ($all_addons as $addonlist => $addons) {
            ...
            if ($addonlist == "esig-price") {
                ...
                if ($license_key == 'no') {
                    ...
                    $esig_action_link = '<div class="esig-add-on-actions"><div class="esig-add-on-buy-now"><a href="https://www.approveme.me/wp-digital-e-signature#pricingPlans" target="_blank" class="eisg-addons-upgrade">' . __('Upgrade Now', 'esig') . '</a></div></div>';
                } elseif ($plugin_file) {
