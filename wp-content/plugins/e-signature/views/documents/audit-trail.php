...
<link rel='stylesheet' id='esig-theme-style-audit-css'  href='<?=ESIGN_ASSETS_DIR_URI?>/css/audit-trail.css' type='text/css' media='all' />
<?php if($esig_pdf_export): ?>
    <link rel='stylesheet' id='esig-theme-style-audit-pdf-css'  href='<?=ESIGN_ASSETS_DIR_URI?>/css/audit-trail-pdf.css' type='text/css' media='all' />
<?php endif; ?>
...
<section id="audit-trail-wrapper" class="column">
    ...
    <div class="header">
        <div class="row document-info">
            <div class="col left rtl-signature-certificate">
                ...
                <div class="document-name"><?php _e("Document name:","esig"); ?> <span><?= esig_unslash($audit_trail_data->document_name) ;?></span></div>
                <div class="subcaption">
                    <span class="image-wrapper"><img style="width: 11px; height: 14px;" src="<?=$images_url?>/lock.png" alt=""></span><?php _e("Unique Document ID:","esig"); ?> <span><?=$audit_trail_data->unique_document_id?></span>
                </div>
            </div>
            <div class="col right logo rtl-sign-contracts">
                <a href="//www.aprv.me/audit-trail" target="_blank"><img style="width: 157px; height: 38px;" src="<?=ESIGN_ASSETS_DIR_URI . '/images/legally-signed.svg' ?>" alt=""></a><br>
            ...
            <div class="signer-view">
                <div class="row info clearfix">
                    ...
                    <div class="col bio left rtl-signer-id">
                        <div><?=$user->name?></div>
                        <div>Party ID: <?=$user->party_id?></div>
                        <?php if($user->signer_ip): ?>
                            <div>IP Address: <?=$user->signer_ip?></div>
                        <?php endif; ?>
                    ...
                    <div class="col sign right rtl-awating-signature">
                        <?php if(isset($user->signature_view->image_url) || isset($user->signature_view->signature_by_type)): ?>
                            ...
                            <div class="digital-signature-image">
                                <?php
                                if($user->signature_view->image_url){
                ...
                <div class="row checksum clearfix rtl-clearfix">
                    ...
                    <div class="col right dfc-image">
                        <img src="<?=$user->dfc_qr_code_image_data?>" alt="">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <?php endif; ?>
	...
	<div class="footer">
        <div class="row clearfix">
            <div class="col left page-url-qr rtl-weapper">
                <div class="wrapper">
                    <img style="width: 90px; height: 90px;" src="<?=$audit_trail_data->current_url_qr?>" alt="">
                </div>
            </div>
	...
	<section class="bottom-footer">
            <div class="blog-url pdf-blog-url"><a href="<?= $audit_trail_data->site_url; ?>"><?= $audit_trail_data->site_url; ?></a></div>
        <?php if($audit_trail_data->audit_signature_id):?>
        <div class="audit-signature pull-right"><img style=" height: auto;width: 12px;margin-top: -5px;margin-right: 5px;" src="<?=$images_url?>/lock.png" alt=""><?php _e('Audit Trail Serial#','esig'); ?> <?=$audit_trail_data->audit_signature_id?></div>
        <?php endif; ?>
	</section>
    ...
    <htmlpagefooter name="Audit_Trail_Footer" >
            ...
            <table>
                <tr>
                    <td class="pdf-qr-code">
                        <img style="width: 80px; height: 80px;" src="<?=$audit_trail_data->current_url_qr?>" alt="">
                    </td>
        ...
        <section class="bottom-footer audit-pdf-bottom-footer">
            <table style="width: 100%;">
                <tr>
                    <td style="width: 40%"><a class="audit-link" href="<?= $audit_trail_data->site_url; ?>"><?= $audit_trail_data->site_url; ?></a></td>
                    <td style="width: 60%; text-align: right; ">
                        <?php if($audit_trail_data->audit_signature_id):?>
                            <div class="pdf-audit-signature audit-signature pull-right"><img style=" height: auto;width: 12px;margin-top: -5px;margin-right: 5px;" src="<?=$images_url?>/lock.png" alt=""> <?php _e('Audit Trail Serial#','esig'); ?> <?=$audit_trail_data->audit_signature_id?></div>
                        <?php endif; ?>
                    </td>
                </tr>
            </table>
