...
<input type="hidden" id="esig-invite-hash" value="<?= $GLOBALS['slv_data']->invite_hash; ?>">
<input type="hidden" id="esig-document-checksum" value="<?= $GLOBALS['slv_data']->checksum; ?>">
...
<div class="container esig-access-form" id="slv-login-form">
    ...
    <div class="row">
        ...
        <div id="password-reset" class="col-lg-6">
            <h4><?= sprintf(__("Login to %s", "esig"), WP_E_Sig()->setting->get_company_name()); ?></h4>
        </div>
        <div class="col-lg-6 esig-verified-logo">
            <a  href="https://www.approveme.me/wordpress-audit-trail-e-signature-certificate/?utm_source=wpesignplugin&utm_medium=access-code&utm_campaign=audit-trail" target="_blank">
            ...
            <span class="access-text"><b>
                    ...
                    <b></span>
                        ...
                        <div class="row" id="esig-password-set-form" style="display: none;">
                            <div class="col-lg-12 ">
<div class="esig-slv-create-pass">The document senders requires that you create a unique password to access this document in the future.  Please create a secure document password below.</div>
                                ...
                                <span class="password-text"><b><?php _e('<span id="access-error-textt">Confirm your password:</span>', 'esig'); ?><b></span>
                                            ...
                                            <div class="container esig-access-form" id="reset-password-popup" style="display:none;" >
                                                <div class="row popup-heading col-lg-12" id="reset-head">
                                                    ...
                                                    <a class="disabled" href="https://www.approveme.me/wordpress-audit-trail-e-signature-certificate/?utm_source=wpesignplugin&utm_medium=access-code&utm_campaign=audit-trail" target="_blank">
