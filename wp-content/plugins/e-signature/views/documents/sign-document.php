		...
		<div class="signatures row">
			...
			<p >
					<?php if (array_key_exists('recipient_first_name', $data)) { 
                                        ...
                                        ?>
						<input  type="text" required class="form-control" id="recipient_first_name" name="recipient_first_name" value="<?php echo $fname; ?>"  <?php echo $data['extra_attr']; ?>   placeholder="<?php _e('Your legal name','esig') ; ?>"/>
					</p>
	...
	<div class="audit-wrapper">
		...
		<div class="row page-break-before">
			<div class="esig-logo col-sm-8 eisg-rtl-legally-signed">
				<a href="//www.aprv.me/audit-trail" target="_blank"><img src="<?php echo ESIGN_ASSETS_DIR_URI ; ?>/images/legally-signed.svg" alt="WP E-Signature"/></a>
			</div>
