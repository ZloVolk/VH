			...
			<form method="post" action="options.php">
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<input type="number" id="dsidxpress-FacebookAppID" name="<?php echo DSIDXPRESS_API_OPTIONS_NAME; ?>[FacebookAppID]" value="<?php echo $fbAppID; ?>" /><br />
							<span class="description">
							...
							Visit the <a hreff="https://developers.facebook.com/apps" target="_blank">Facebook Developers Apps Page</a> to create / find your App ID.
							</span>
						</td>
					</tr>
				</table>
