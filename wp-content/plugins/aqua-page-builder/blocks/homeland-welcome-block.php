...
class Homeland_Welcome_Block extends AQ_Block {
	...
	function block($instance) {
		...
		if(!empty($homeland_background)) :
			?><style>.welcome-pb-block { background: url('<?php echo $homeland_background; ?>') no-repeat center !important; background-size: cover !important; }</style><?php
		endif;

		if(!empty($homeland_overlay)) :
			?><style>.welcome-pb-block .overlay { background-color: <?php echo $homeland_overlay; ?> !important; }</style><?php
		endif;
