...
class Homeland_Partners_Block extends AQ_Block {
	...
	function block($instance) {
		...
		if(!empty($homeland_background)) :
			?><style>.partners-block { background: url('<?php echo $homeland_background; ?>') no-repeat center !important; background-size: cover !important; }</style><?php
		endif;

		if(!empty($homeland_overlay)) :
			?><style>.partners-block .overlay { background-color: <?php echo $homeland_overlay; ?> !important; }</style><?php
		endif;
