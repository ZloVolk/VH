...
<div id="esig-pdf-error-dialog">
 ...
 $esig_user= new WP_E_User();
  $esig_settings= new WP_E_Setting();
      ...
      echo $users->first_name . ",";?> <?php _e(" I apologize, but we're having trouble connecting to your <em>Save as PDF add-on</em> (which is required to use this feature). ","esig-pdfemail"); ?><strong> <?php _e(" For your site to magically create PDF's,","esig-pdfemail"); ?> <?php _e('you will definitely need our "Save as PDF" add-on.','esig-pdfemail');?></strong></p>
    ...
    if($esig_settings->esig_license_expired())
    {
     ...
     <p><?php _e('To complicate the situation, It looks like your license is expired... you will need to have a valid license in order install this add-on.','esig-pdfemail');?></p>
  
   <!-- esig updater button section -->
		<div class="esig-updater-button">
           <span> <a href="https://www.approveme.me/checkout/?edd_license_key=<?php echo $license_key ;  ?>&download_id=2660" class="button" id="esig-primary-dgr-btn"> <?php _e('Please Renew My License','esig');?> </a></span>
		</div>
	...
	<?php 
	 ...
	 ?>
	 	<p><?php _e('To complicate the situation, only the super admin <?php echo $s_first_name . " " . $s_last_name ;  ?> can install/activate add-ons.  ','esig-pdfemail');?></p>
   ...
   <!-- esig updater button section -->
	...
	<?PHP
	 ...
	 {
	 ?>
	 	<p><?php _e('To complicate the situation, it also looks like you do not have a license key (which means your site cannot communicate with ApproveMe and receive critical updates, downloads etc)... you will need to have a valid license in order to install this add-on. ','esig-pdfemail');?></p>
  
   <!-- esig updater button section -->
		<div class="esig-updater-button">
           <span> <a href="https://www.approveme.me/#pricingPlans" class="button" id="esig-primary-dgr-btn"> <?php _e('Get My License Key','esig');?> </a></span>
		</div>
	<?PHP
	 } // license activation check end here  
	 else 
