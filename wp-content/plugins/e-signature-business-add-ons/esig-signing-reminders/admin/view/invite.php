...
<div id=":zs" class="ii gt m1436f203bed358e3 adP adO">
  <div id=":zr" style="overflow: hidden;">
    <div class="adM"> </div>
    <div
style="background-color:#efefef;margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;max-width:600px;margin: 0 auto;">
         <!--[if mso]>
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
  ...
  <td align="center" width="175" height="40" bgcolor="<?php echo $background_color ;  ?>" style="color: #ffffff; display: block;">
                ...
                <tbody>
                  <tr style="border-collapse:collapse">
                    <td style="padding: 16px 12px 0px 20px;vertical-align: top;font-family: 'Helvetica Neue',Arial,Helvetica,sans-serif;font-size: 12px;line-height: 1.5em;border-collapse: collapse;color: #555;"
                      align="left"><?php echo sprintf( __( 'This message was sent to you by %s who is using the <a href="https://www.approveme.me/" style="text-decoration:none;color:#555;">WP E-Signature Document Signing WordPress plugin</a>. If you would rather not receive email from this sender you may contact the sender with your request.', 'esig-reminders'), $data['user_full_name'] );?> </td>
