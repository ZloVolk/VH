...
if(class_exists( 'WP_E_Addon' ))
{
	...
	$esign_addons->esign_update_check('4326','1.4.4');
}   
 ...
 * @since 1.1.3
 */
if(!function_exists('esig_reminders_load_textdomain')){  
...
add_action( 'wp_esignature_loaded', 'esig_reminders_load_textdomain');
}
