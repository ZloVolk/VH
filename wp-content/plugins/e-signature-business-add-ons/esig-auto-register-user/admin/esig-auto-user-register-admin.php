...
if (!class_exists('ESIG_AUTO_REGISTER_Admin')) :
    ...
    class ESIG_AUTO_REGISTER_Admin extends Esig_Register_Settings {
        ...
        private function __construct() {
             ...
             */
            $plugin = ESIG_AUTO_REGISTER::get_instance();
        ...
        public function esig_misc_settings_save($args) {
            ...
            WP_E_Sig()->setting->set('esig-force-login', $force_login);

            WP_E_Sig()->setting->set('esig-auto-reg-global', $misc_ready);
            
            WP_E_Sig()->setting->set('esig_misc_content', $esig_misc_content);
            WP_E_Sig()->setting->set('esig-auto-reg-email-temp', $esig_misc_content_textarea);
            WP_E_Sig()->setting->set('esig_misc_email_subject', $esig_misc_email_subject);
        ...
        public function esig_document_complate($args) {
            ...
            if ($register_settings->esig_auto_add_register == 1) {
                ...
                $owner = WP_E_Sig()->user->getUserByID($owner_id);
                $organizaiton_name = WP_E_Sig()->setting->get("company_logo", $documents->user_id);
                ...
                if ($esig_enable_admin_email) {
                    ...
                    $admin_message = WP_E_Sig()->view->renderPartial('', $signer_data, false, '', $notify_template);
        ...
        public function enqueue_admin_scripts() {
            ...
            if (in_array($screen->id, $admin_screens)) {
                ...
                wp_enqueue_script($this->plugin_slug . '-admin-script', plugins_url('assets/js/esig-auto-add-register.js', __FILE__), array('jquery', 'jquery-ui-dialog'), ESIG_AUTO_REGISTER::VERSION, true);
            }
        }
