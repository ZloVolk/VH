...
if(class_exists( 'WP_E_Addon' ))
{
	...
	$esign_addons->esign_update_check('7878','1.4.4');
}
...
require_once( dirname( __FILE__ ) . '/includes/esig-add-custom-message.php' );
...
require_once( dirname( __FILE__ ) . '/admin/esig-add-custom-message-admin.php' );
add_action( 'wp_esignature_loaded', array( 'ESIG_CUSTOM_MESSAGE_Admin', 'get_instance' ) );
 ...
 * @since 1.1.3
 */
if(!function_exists('esig_custom_message_load_textdomain')){
...
add_action( 'wp_esignature_loaded', 'esig_custom_message_load_textdomain');
}
