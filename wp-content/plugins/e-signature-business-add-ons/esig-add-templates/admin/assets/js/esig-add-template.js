...
(function ($) {
    ...
    $('#template_view').click(function (event) {
        ...
        tb_show("", '#TB_inline?width=480&height=350&inlineId=template-option-step2');
    });
    ...
    $('body').on('click', '#recipient_emails_temp .deleteIcon', function () {
    ...
    $.fn.template_email_duplicate = function () {
        ...
        for (var i = 0; i < view_fname.length; i++) {
            ...
            if (blank)
            {
                ...
                $('#standard_view_popup_bottom .af-inner').append('<span class="esig-error-box">*You must fill the signer name.</span>');
                return true;
            }
        }
