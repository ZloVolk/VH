...
//
// Copyright (c) 2008-2015 MLCALC.COM
...
Author: MLCalc.com - Mortgage Calculator
Version: 1.5.5
...
function display_mlcalc($options = array(), $content = null, $code = "") {
	global $mlcalcURL;
	if(!empty($code) || (!empty($options) && ($options[0] == 'mlcalc'))){
		$shortcode = true;
		...
		extract( shortcode_atts( array(
			// default parameters
			'default' => 'loan', // mortgage|loan|mortgage_only|loan_only
