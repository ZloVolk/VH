...
LOCK TABLES `wpqp_rg_incomplete_submissions` WRITE;
/*!40000 ALTER TABLE `wpqp_rg_incomplete_submissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `wpqp_rg_incomplete_submissions` ENABLE KEYS */;
UNLOCK TABLES;
