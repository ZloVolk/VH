...
DROP TABLE IF EXISTS `wpqp_rg_lead`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wpqp_rg_lead` (
...
LOCK TABLES `wpqp_rg_lead` WRITE;
/*!40000 ALTER TABLE `wpqp_rg_lead` DISABLE KEYS */;
/*!40000 ALTER TABLE `wpqp_rg_lead` ENABLE KEYS */;
UNLOCK TABLES;
