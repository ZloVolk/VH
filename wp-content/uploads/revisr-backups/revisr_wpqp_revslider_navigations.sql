...
LOCK TABLES `wpqp_revslider_navigations` WRITE;
/*!40000 ALTER TABLE `wpqp_revslider_navigations` DISABLE KEYS */;
/*!40000 ALTER TABLE `wpqp_revslider_navigations` ENABLE KEYS */;
UNLOCK TABLES;
