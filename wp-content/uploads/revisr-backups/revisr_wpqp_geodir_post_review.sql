...
CREATE TABLE `wpqp_geodir_post_review` (
  ...
  `rating_ip` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ratings` text COLLATE utf8_unicode_ci,
  `overall_rating` float DEFAULT NULL,
  `comment_images` text COLLATE utf8_unicode_ci,
  `wasthis_review` int(11) NOT NULL,
  `status` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `post_status` int(11) DEFAULT NULL,
  `post_date` datetime NOT NULL,
  `post_city` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `post_region` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `post_country` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
