<?php 
	...
	elseif($homeland_archive_layout == "List Alternate") :
		$homeland_archive_class_main = "left-container";
		$homeland_archive_class_container = "blog-list-alternate clear";
		$homeland_archive_class_sidebar = "sidebar";
...
?>
	...
	<section class="theme-pages">
		<div class="inside clear">
			...
			<?php if($homeland_archive_layout != "Timeline" && $homeland_archive_layout != "Fullwidth" && $homeland_archive_layout != "2 Columns" && $homeland_archive_layout != "3 Columns" && $homeland_archive_layout != "4 Columns") : ?>
				<div class="<?php echo $homeland_archive_class_sidebar; ?>"><?php get_sidebar(); ?></div>
			<?php endif; ?>
		</div>
	</section>
