...
<li id="post-<?php the_ID(); ?>" class="clear">
	...
	<div class="agent-property-desc">
		...
		<?php
			if(empty($homeland_all_agents)) : ?>
				<div class="agent-info">
					...
					?>
					<label>
						<span><?php _e('Agent:', 'homeland'); ?></span> <?php the_author_meta('display_name' ); ?>
					</label>
				</div><?php
			else :
		...
		?>
		<a href="<?php the_permalink(); ?>" class="view-profile read-more-property"><?php echo $homeland_property_button_label; ?></a>
	</div>
</li>