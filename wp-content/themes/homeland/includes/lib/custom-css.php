<?php
			...
			<style type="text/css"><?php	
				...
				if($homeland_bg_type == "Pattern") :
					...
					elseif($homeland_pattern == "Confectionary") :
						?>body { background:url('<?php echo get_template_directory_uri(); ?>/img/patterns/confectionary.png') repeat top fixed !important; }<?php
					elseif($homeland_pattern == "Dark Sharp Edges") :
						?>body { background:url('<?php echo get_template_directory_uri(); ?>/img/patterns/footer_lodyas.png') repeat top fixed !important; }<?php
					elseif($homeland_pattern == "Subtle White Feathers") :
						?>body { background:url('<?php echo get_template_directory_uri(); ?>/img/patterns/subtle_white_feathers.png') repeat top fixed !important; }<?php
					elseif($homeland_pattern == "Tileable Wood") :
						?>body { background:url('<?php echo get_template_directory_uri(); ?>/img/patterns/tileable_wood_texture.png') repeat top fixed !important; }<?php
					elseif($homeland_pattern == "Pineapple Cut") :
						?>body { background:url('<?php echo get_template_directory_uri(); ?>/img/patterns/pineapplecut.png') repeat top fixed !important; }<?php
					endif;
				...
				if(!empty($homeland_footer_text_color)) :	?>
					footer, 
					.widget-column { color:<?php echo $homeland_footer_text_color ?> !important; } <?php
				endif;
				...
				elseif($homeland_theme_font == "Poppins") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Poppins', sans-serif !important; }<?php
				elseif($homeland_theme_font == "PT Serif") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'PT Serif', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Nixie One") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Nixie One', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Fira Sans") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Fira Sans', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Quattrocento Sans") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Quattrocento Sans', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Kreon") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Kreon', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Varela Round") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Varela Round', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Bitter") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Bitter', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Catamaran") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Catamaran', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Ruda") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Ruda', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Cambay") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Cambay', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Rajdhani") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Rajdhani', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Comfortaa") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Comfortaa', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Poiret One") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Poiret One', sans-serif !important; }<?php
				elseif($homeland_theme_font == "Work Sans") : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
					.widget_revslider .tp-caption { font-family:'Work Sans', sans-serif !important; }<?php
				else : ?>
					body, h1, h2, h3, h4, h5, h6, input, textarea, select, 
	...
	if ( ! function_exists( 'homeland_custom_font_family' ) ) :
		function homeland_custom_font_family() {
			...
			if($homeland_theme_font == "Open Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,800,700,600,300&subset=latin,cyrillic-ext,greek-ext,greek,vietnamese,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Droid Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Droid+Sans:400,700' );
			elseif($homeland_theme_font == "Lato") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Lato:100,300,400,700,900,100italic,300italic,400italic,700italic,900italic' );
			elseif($homeland_theme_font == "Raleway") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Raleway:400,100,200,300,500,600,700,900,800' );
			elseif($homeland_theme_font == "PT Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=PT+Sans:400,700,400italic,700italic&subset=latin,cyrillic-ext,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Noto Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Noto+Sans:400,700,400italic,700italic&subset=latin,cyrillic-ext,greek-ext,greek,vietnamese,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Oxygen") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Oxygen:400,300,700&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Source Sans Pro") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Source+Sans+Pro:200,300,400,600,700,900,200italic,300italic,400italic,600italic,700italic,900italic&subset=latin,vietnamese,latin-ext' );
			elseif($homeland_theme_font == "Muli") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Muli:300,400,300italic,400italic' );
			elseif($homeland_theme_font == "Istok Web") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Istok+Web:400,700,400italic,700italic&subset=latin,cyrillic-ext,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Puritan") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Puritan:400,700,400italic,700italic' );
			elseif($homeland_theme_font == "Gafata") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Gafata&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Cambo") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Cambo' );	
			elseif($homeland_theme_font == "Voces") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Voces&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Duru Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Duru+Sans&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Sintony") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Sintony:400,700&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Carrois Gothic") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Carrois+Gothic' );
			elseif($homeland_theme_font == "Alegreya Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Alegreya+Sans:100,300,400,500,700,800,900,100italic,300italic,400italic,500italic,700italic,800italic,900italic&subset=latin,vietnamese,latin-ext' );	
			elseif($homeland_theme_font == "News Cycle") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=News+Cycle:400,700&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Dosis") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Dosis:200,300,400,500,600,700,800&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Abel") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Abel' );
			elseif($homeland_theme_font == "Didact Gothic") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Didact+Gothic&subset=latin,greek-ext,greek,latin-ext,cyrillic,cyrillic-ext' );
			elseif($homeland_theme_font == "Arimo") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Arimo:400,700,400italic,700italic&subset=latin,cyrillic-ext,cyrillic,greek-ext,greek,vietnamese,latin-ext' );
			elseif($homeland_theme_font == "Titillium Web") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Titillium+Web:400,200,200italic,300,300italic,400italic,600,600italic,700,700italic,900&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Archivo Narrow") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Archivo+Narrow:400,400italic,700,700italic&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Josefin Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Josefin+Sans:100,300,400,600,700,100italic,300italic,400italic,600italic,700italic' );
			elseif($homeland_theme_font == "Asap") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Asap:400,700,400italic,700italic&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Questrial") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Questrial' );
			elseif($homeland_theme_font == "Pontano Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Pontano+Sans&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Slabo") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Slabo+27px&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Oswald") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Oswald:400,300,700&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Montserrat") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Montserrat:400,700' );
			elseif($homeland_theme_font == "Ubuntu") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Ubuntu:300,400,500,700,300italic,400italic,500italic,700italic&subset=latin,cyrillic-ext,greek-ext,greek,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Merriweather") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic,900,900italic&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Cabin") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Cabin:400,500,600,700,400italic,500italic,600italic,700italic' );
			elseif($homeland_theme_font == "Hind") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Hind:400,300,500,600,700&subset=latin,devanagari,latin-ext' );
			elseif($homeland_theme_font == "Gudea") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Gudea:400,700,400italic&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Noticia Text") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Noticia+Text:400,400italic,700,700italic&subset=latin,vietnamese,latin-ext' );
			elseif($homeland_theme_font == "Nobile") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Nobile:400,400italic,700,700italic' );
			elseif($homeland_theme_font == "Lora") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Lora:400,700,400italic,700italic&subset=latin,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Inconsolata") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Inconsolata:400,700&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Quicksand") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Quicksand:300,400,700' );
			elseif($homeland_theme_font == "Karla") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Karla:400,400italic,700,700italic&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Monda") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Monda:400,700&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Crimson Text") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Crimson+Text:700italic,600,600italic,400,700,400italic' );
			elseif($homeland_theme_font == "Exo") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Exo:100,200,300,400,500,600,700,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "EB Garamond") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=EB+Garamond&subset=latin,vietnamese,cyrillic-ext,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Armata") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Armata&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Glegoo") : 
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Glegoo:400,700&subset=latin,devanagari,latin-ext' );
			elseif($homeland_theme_font == "Poppins") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Poppins:400,700,600,500,300&subset=latin,devanagari,latin-ext' );
			elseif($homeland_theme_font == "PT Serif") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=PT+Serif:400,400italic,700,700italic&subset=latin,cyrillic-ext,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Nixie One") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Nixie+One' );
			elseif($homeland_theme_font == "Fira Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Fira+Sans:400,300,300italic,400italic,500,500italic,700,700italic&subset=latin,greek,cyrillic-ext,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Quattrocento Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Quattrocento+Sans:400,400italic,700,700italic&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Kreon") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Kreon:400,300,700' );
			elseif($homeland_theme_font == "Varela Round") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Varela+Round' );
			elseif($homeland_theme_font == "Bitter") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Bitter:400,400italic,700&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Bitter") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Bitter:400,400italic,700&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Catamaran") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Catamaran:400,100,200,300,500,600,700,800,900&subset=latin,tamil,latin-ext' );
			elseif($homeland_theme_font == "Ruda") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Ruda:400,700,900&subset=latin,latin-ext' );
			elseif($homeland_theme_font == "Cambay") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Cambay:400,400italic,700,700italic&subset=latin,latin-ext,devanagari' );
			elseif($homeland_theme_font == "Rajdhani") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Rajdhani:400,300,500,600,700&subset=latin,latin-ext,devanagari' );
			elseif($homeland_theme_font == "Comfortaa") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Comfortaa:400,300,700&subset=latin,greek,cyrillic-ext,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Poiret One") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Poiret+One&subset=latin,latin-ext,cyrillic' );
			elseif($homeland_theme_font == "Work Sans") : 
				wp_enqueue_style( 'homeland_custom_font', 'https://fonts.googleapis.com/css?family=Work+Sans:400,100,300,200,500,600,700,800,900&subset=latin,latin-ext' );
			else :
				wp_enqueue_style( 'homeland_custom_font', 'http://fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic&subset=latin,cyrillic-ext,greek-ext,greek,vietnamese,latin-ext,cyrillic' );
			endif;
		}
	endif;
