...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => get_stylesheet_directory() . '/includes/lib/plugins/codeex-shortcodes.zip', // The plugin source.
        ...
        array(
            ...
            'source'             => get_stylesheet_directory() . '/includes/lib/plugins/aqua-page-builder.zip', 
            'required'           => true, 
            'version'            => '1.1.5', 
        ...
        array(
            ...
            'slug'               => 'revslider', 
            'source'             => get_stylesheet_directory() . '/includes/lib/plugins/revslider.zip', 
            'required'           => true, 
            'version'            => '5.2.5.3', 
            'force_activation'   => false, 
            'force_deactivation' => false, 
