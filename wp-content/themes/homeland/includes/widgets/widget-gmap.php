<?php	
	...
	class homeland_Widget_GMap extends WP_Widget {
		...
		function homeland_Widget_GMap() {		
			$widget_ops = array('classname' => 'homeland_widget-gmap', 'description' => __('Custom widget for google map', 'homeland'));	
			parent::__construct('GoogleMap', __('Homeland: Google Map', 'homeland'), $widget_ops);	
		}
		...
		function widget($args, $instance) {		
			...
			if (empty($title)) $title = false;
				...
				?>
					...
					<div>			
						<div>
							<p><label for="<?php echo $this -> get_field_id($homeland_map_lat); ?>"><?php _e('Latitude', 'homeland'); ?></label>
							...
							<p><label for="<?php echo $this -> get_field_id($homeland_map_lng); ?>"><?php _e('Longitude', 'homeland'); ?></label>
							...
							<p><label for="<?php echo $this -> get_field_id($homeland_map_zoom); ?>"><?php _e('Zoom', 'homeland'); ?></label>
