<?php
	...
	class homeland_Widget_Featured_Properties extends WP_Widget {
		...
		function homeland_Widget_Featured_Properties() {		
			$widget_ops = array('classname' => 'homeland_widget-featured-properties', 'description' => __('Custom widget for featured properties', 'homeland'));	
			parent::__construct('FeaturedProperties', __('Homeland: Featured Properties', 'homeland'), $widget_ops);		
		}
		...
		function widget($args, $instance) {		
			...
			if (empty($title)) $title = false;
				...
				?>
					...
					<div>			
						<div>
							<p><label for="<?php echo $this -> get_field_id($property_limit); ?>"><?php _e('Number of Posts', 'homeland'); ?></label>
