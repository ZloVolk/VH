<?php
	...
	class homeland_Widget_GetTouch extends WP_Widget {
		...
		function homeland_Widget_GetTouch() {		
			$widget_ops = array('classname' => 'homeland_widget-get-in-touch', 'description' => __('Custom widget for connect with us', 'homeland'));	
			parent::__construct('GetTouch', __('Homeland: Connect with us', 'homeland'), $widget_ops);		
		}
		...
		function widget($args, $instance) {		
			...
			if (empty($title)) $title = false;
				...
				?>
					...
					<div>	
						<small><i><?php _e( 'Social links will automatically display, set id and name in Theme Options', 'homeland' ); ?></i></small>	
					</div>
		<?php
				}			
		}
