<?php
	...
	class homeland_Widget_Facebook_Like extends WP_Widget {
		...
		function homeland_Widget_Facebook_Like() {		
			$widget_ops = array('classname' => 'homeland_widget-facebook-like', 'description' => __('Custom widget for facebook like box', 'homeland'));	
			parent::__construct('FacebookLikeBox', __('Homeland: Facebook Like Box', 'homeland'), $widget_ops);		
		}
		...
		function widget($args, $instance) {		
			...
			if (empty($title)) $title = false;					
				...
				?>
					<div>			
						<div>
							<p><label for="<?php echo $this -> get_field_id($homeland_page_url); ?>"><?php _e('Facebook Page URL', 'homeland'); ?></label>
