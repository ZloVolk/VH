<?php	
	...
	class homeland_Widget_TwitterFeed extends WP_Widget {
		...
		function homeland_Widget_TwitterFeed() {		
			$widget_ops = array('classname' => 'homeland_widget-twitter', 'description' => __('Custom widget for twitter feed', 'homeland'));	
			parent::__construct('Twitter', __('Homeland: Twitter Feed', 'homeland'), $widget_ops);		
		}
			...
			if (empty($title)) $title = false;
				...
				function form($instance) {				
					...
					?>
						...
						<div>			
							<div>
								<p><label for="<?php echo $this -> get_field_id($homeland_twitter_id); ?>"><?php _e('ID', 'homeland'); ?></label>
								...
								<p><label for="<?php echo $this -> get_field_id($homeland_twitter_limit); ?>"><?php _e('Limit', 'homeland'); ?></label>
								...
								<p><label for="<?php echo $this -> get_field_id($homeland_twitter_loading_text); ?>"><?php _e('Loading Text', 'homeland'); ?></label>
