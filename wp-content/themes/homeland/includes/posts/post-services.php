	...
	if ( ! function_exists( 'homeland_services_post_type' ) ) :
		function homeland_services_post_type() {
			register_post_type( 'homeland_services',
				array(
					'labels' => array(
						'name' => __( 'Services', 'homeland' ),
						'singular_name' => __( 'Services', 'homeland' ),
						'add_new' => __( 'Add New', 'homeland' ),
						'add_new_item' => __( 'Add New Services', 'homeland' ),
						'edit_item' => __( 'Edit Services', 'homeland' ),
						'search_items' => __( 'Search Services', 'homeland' ),
						'not_found' => __( 'No services found.', 'homeland' ),
						'not_found_in_trash' => __( 'No services found in Trash.', 'homeland' ),
					),
					'public' => true,
					'has_archive' => true,	
					'exclude_from_search' => true,
					'rewrite' => array('slug' => __( 'services-item', 'homeland' ), 'with_front' => TRUE),
				...
				<div class="mabuc-form-wrap">
					...
					<ul class="mabuc-tabs">
						...
						<li class="mabuc-tab-link" data-tab="tab-2">
							<i class="fa fa-circle"></i><?php _e( 'Icon', 'homeland' ); ?>
						</li>
					...
					<div id="tab-1" class="mabuc-tab-content current">
						<ul>
							<li>
								<label for="homeland_advance_search"><?php esc_attr( _e( 'Hide Search', 'homeland' ) ); ?></label>
						...
						<ul>
							...
							<li>
								<label for="homeland_custom_icon">
									<?php _e( 'Custom Icon', 'homeland' ); ?>
								</label>
								<input name="homeland_custom_icon" type="text" id="homeland_custom_icon" value="<?php echo esc_attr( $homeland_custom_icon ); ?>" /> <input id="upload_image_button_homeland_custom_icon" type="button" value="<?php _e( 'Upload', 'homeland' ); ?>" class="button-secondary" /><br>
								<span class="desc"><?php _e( 'Please upload custom icon by clicking upload button', 'homeland' ); ?></span>
							</li>
						</ul>
					</div>
					...
					<div id="tab-3" class="mabuc-tab-content">
						<ul>
							...
							<li>
								...
								<span class="desc"><?php esc_attr( _e( 'Please upload background image. Otherwise default background image from theme options will be displayed', 'homeland' ) ); ?></span>
							</li>
						</ul>
					</div>
				</div>	
	...
	if ( ! function_exists( 'homeland_edit_services_columns' ) ) :
		function homeland_edit_services_columns( $columns ) {
			$columns = array(
				...
				'link' => __( 'Link', 'homeland' ),		
				'icon' => __( 'Icon', 'homeland' ),		
