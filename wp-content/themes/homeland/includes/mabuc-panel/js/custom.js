(function($) {
    ...
    $('#homeland_welcome_overlay').wpColorPicker();
    $('#homeland_services_overlay').wpColorPicker();
    $('#homeland_testi_overlay').wpColorPicker();
    $('#homeland_header_overlay').wpColorPicker();
    $('#homeland_partners_overlay').wpColorPicker();
    ...
    jQuery('#upload_image_button_homeland_partners_bgimage').click(function() {
        formfield = jQuery('#homeland_partners_bgimage').attr('name');
        tb_show('', 'media-upload.php?type=image&amp;width=640&amp;height=550&amp;TB_iframe=true');
        return false;           
    });
    ...
    jQuery('#upload_image_button_homeland_attachment_bgimage').click(function() {
        formfield = jQuery('#homeland_attachment_bgimage').attr('name');
        tb_show('', 'media-upload.php?type=image&amp;width=640&amp;height=550&amp;TB_iframe=true');
        return false;           
    });
    ...
    jQuery('#upload_image_button_homeland_attachment_hdimage').click(function() {
        formfield = jQuery('#homeland_attachment_hdimage').attr('name');
        tb_show('', 'media-upload.php?type=image&amp;width=640&amp;height=550&amp;TB_iframe=true');
        return false;           
    });
