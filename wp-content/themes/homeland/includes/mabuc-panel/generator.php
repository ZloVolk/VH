<?php
	function homeland_mytheme_admin() {
		global $themename, $shortname, $options, $version, $help, $author, $docs;
		$i=0;

		if ( isset($_REQUEST['saved']) ) : ?>
			<div id="message" class="updated fade">
				<p><strong><?php echo $themename . "&nbsp;"; _e( 'Settings Saved', 'homeland' ); ?></strong></p>
			</div>
		...
		if ( isset($_REQUEST['reset']) ) : ?>
			<div id="message" class="updated fade">
				<p><strong><?php echo $themename . "&nbsp;"; _e( 'Settings Reset', 'homeland' ); ?></strong></p>
			</div><?php
		endif;
		...
		<div class="wrap mabuc_wrap">
			<h2><?php echo $themename; ?> <p class="mabuc-version"><?php _e( 'version', 'homeland' ); echo "&nbsp;" . $version; ?></p></h2>
			<div class="mabuc_opts">
				<p>
					<?php 
						printf ( __( 'Enter your Settings for %1$s. If you have any questions please refer to the user manual.', 'homeland' ), $themename ); 
					?> 
				</p>	
				<form method="post">
					<?php 
		...
		<?php 
			...
			// Headers
			case "headers":
				echo "<h5>". $homeland_value_name ."</h5>";
			...
			case 'slide_amount':
				...
				?>
					<div class="mabuc_input mabuc_text <?php echo $homeland_value_id; ?>">
						...
						<input type="text" id="<?php echo $homeland_value_id; ?>" name="<?php echo $homeland_value_id; ?>" class="slide-amount" readonly maxlength="2">
			...
			case 'slide_amount_fonts':
				...
				?>
					<div class="mabuc_input mabuc_text <?php echo $homeland_value_id; ?>">
						<label for="<?php echo $homeland_value_id; ?>"><?php echo $homeland_value_name; ?></label>
						<div id="<?php echo $homeland_value_id; ?>_value" class="slider-range"></div>
						<input type="text" id="<?php echo $homeland_value_id; ?>" name="<?php echo $homeland_value_id; ?>" class="slide-amount" readonly maxlength="3">
						<small><?php echo $homeland_value_desc; ?></small><div class="clearfix"></div>
			...
			case 'upload':
				...
				?>
					<div class="mabuc_input mabuc_text <?php echo $homeland_value_id; ?>">
						...
						<input id="upload_image_button_<?php echo $homeland_value_id; ?>" type="button" value="<?php _e( 'Upload', 'homeland' ); ?>" class="button-secondary" />
						<small><?php echo $homeland_value_desc; ?></small><div class="clearfix"></div>
					</div>		
				<?php
			break;
...
?>
			...
			<div class="clear">
				<div class="btn-actions">
					<span><input name="save" type="submit" value="<?php _e( 'Save Changes', 'homeland' ); ?>" class="button-primary" /></span>	
				</div>
				<div class="btn-actions-right">
					<span>
						<input name="support" type="button" value="<?php _e( 'Ask for Help?', 'homeland' ); ?>" class="button-primary" onClick="window.open('<?php echo $help; ?>')" />
					</span>	
					<span><input name="themes" type="button" value="<?php _e( 'More Themes', 'homeland' ); ?>" class="button-primary" onClick="window.open('http://themeforest.net/user/<?php echo $author; ?>/portfolio')" /></span>
					<span><input name="themes" type="button" value="<?php _e( 'Documentation', 'homeland' ); ?>" class="button-primary" onClick="window.open('<?php echo $docs; ?>')" /></span>	
				</div>
			</div>
		</form>
	</div>
