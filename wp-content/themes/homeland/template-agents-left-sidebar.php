...
<?php 
	...
	$homeland_agent_button_label = !empty($homeland_agent_button) ? $homeland_agent_button : __('View Profile', 'homeland'); 
						      ...
						      ?>
						    	<div class="agent-list clear">
						    		...
						    		<div class="agent-desc">
						    			<h4>
						    				<a href="<?php echo esc_url( get_author_posts_url( $homeland_agent_id ) ); ?>"><?php echo $homeland_agent_name; ?></a>
						    			</h4>
						    				...
						    				<?php
						    					if(!empty($homeland_agent_telno)) : ?>
						    						<span>
						    							...
						    							<strong><?php esc_attr( _e( 'Tel no', 'homeland' ) ); echo ":"; ?></strong>
						    					...
						    					if(!empty($homeland_agent_mobile)) : ?>
						    						<span>
						    							...
						    							<strong><?php esc_attr( _e( 'Mobile', 'homeland' ) ); echo ":"; ?></strong>
						    					...
						    					if(!empty($homeland_agent_fax)) : ?>
						    						<span>
						    							...
						    							<strong><?php esc_attr( _e( 'Fax', 'homeland' ) ); echo ":"; ?></strong> 
							    		...
							    		<label class="listed">
							    			<i class="fa fa-home fa-lg"></i> <?php esc_attr( _e( 'Listed', 'homeland' ) ); echo ":"; ?>
							    			<span><?php echo intval($homeland_count); echo "&nbsp;"; esc_attr( _e( 'Properties', 'homeland' ) ); ?></span>
							    		</label>
							    		<a href="<?php echo esc_url( get_author_posts_url( $homeland_agent_id ) ); ?>" class="view-profile"><?php echo $homeland_agent_button_label; ?></a>
						    		</div>
						    	</div>	
						    	<?php
						   endforeach;
