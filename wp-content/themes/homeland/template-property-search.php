...
<?php 
	...
	$homeland_advance_search_layout = esc_attr( get_option('homeland_advance_search_layout') );
	...
	if($homeland_advance_search_layout == "Left Sidebar") :
	...
	elseif($homeland_advance_search_layout == "1 Column") :
	...
	elseif($homeland_advance_search_layout == "2 Columns") :
		$homeland_property_search_class_main = "theme-fullwidth";
	...
	elseif($homeland_advance_search_layout == "Grid Left Sidebar") :
		$homeland_property_search_class_main = "left-container right";
		$homeland_property_search_class_container = "property-list property-grid-sidebar property-four-cols clear";
		$homeland_property_search_class_masonry_cols = "masonry";
		$homeland_property_search_class_sidebar = "sidebar left";
		...
		<div class="inside clear">
            ...
            if ( $wp_query->have_posts() ) : ?>
            	<!-- Search Count -->
        				...
        				<?php 
        					echo $wp_query->found_posts . "&nbsp;"; _e( 'Properties found...', 'homeland' ); 
        				?>
        			</div>
            	...
            	<div class="grid cs-style-3 <?php echo $homeland_property_search_class_masonry_cols; ?>">
            		<ul class="clear">
                	<?php
                		if($homeland_advance_search_layout == "1 Column") :
                        ...
                        for($homeland_i = 1; $wp_query->have_posts(); $homeland_i++) {
                			...
                			for($homeland_i = 1; $wp_query->have_posts(); $homeland_i++) {
										...
										elseif($homeland_advance_search_layout == "Grid Sidebar" || $homeland_advance_search_layout == "Grid Left Sidebar") :
                			for($homeland_i = 1; $wp_query->have_posts(); $homeland_i++) {
												$wp_query->the_post();			
												$homeland_columns = 3;	
												$homeland_class = 'property-cols masonry-item ';
                  ...
                  ?>
							...
							<div class="search-count search-error">
								<?php _e( 'Your search query returned 0 results!', 'homeland' ); ?>
		          </div><?php
            endif;
					?>
				</div>
			...
			<?php if($homeland_advance_search_layout != "1 Column" && $homeland_advance_search_layout != "2 Columns" && $homeland_advance_search_layout != "3 Columns" && $homeland_advance_search_layout != "4 Columns") : ?>
				<div class="<?php echo $homeland_property_search_class_sidebar; ?>"><?php get_sidebar(); ?></div>
			<?php endif; ?>
		</div>
	</section>
