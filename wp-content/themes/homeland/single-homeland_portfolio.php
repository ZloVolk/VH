		...
		<div class="inside clear">
			<div class="<?php echo $homeland_single_layout_class; ?>">				
					...
					if (have_posts()) : 
						if ( post_password_required() ) :
							...
							while (have_posts()) : the_post(); ?>
								<article id="post-<?php the_ID(); ?>" <?php sanitize_html_class( post_class() ); ?>>
		    	...
		    	<div class="post-link-blog clear">
					<span class="prev">
						<?php previous_post_link( '%link', '&larr;&nbsp;' . __( 'Previous Post', 'homeland' ), '' ); ?>
					</span>
					<span class="next">
			...
			<?php if($homeland_single_portfolio_layout == "Right Sidebar" || $homeland_single_portfolio_layout == "Left Sidebar") : ?>
				<div class="<?php echo $homeland_portfolio_class_sidebar; ?>"><?php get_sidebar(); ?></div>
			<?php endif; ?>
		</div>
	</section>
