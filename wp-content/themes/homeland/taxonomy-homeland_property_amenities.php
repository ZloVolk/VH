...
?>
	...
	<section class="theme-pages">
		<div class="inside clear">	
					...
					<?php
		         	...
		         	if(empty($homeland_hide_map_list)) : echo "<section id='map-homepage'></section>"; endif;
						...
						if ( $wp_query->have_posts() ) : ?>
							...
							<!-- Search Count -->
							<div class="search-count"><?php echo $wp_query->found_posts . "&nbsp;"; _e( 'Properties found...', 'homeland' ); ?></div>
			...
			<?php if($homeland_tax_layout != "1 Column" && $homeland_tax_layout != "2 Columns" && $homeland_tax_layout != "3 Columns" && $homeland_tax_layout != "4 Columns") : ?>
				<div class="<?php echo $homeland_tax_class_sidebar; ?>"><?php get_sidebar(); ?></div>
			<?php endif; ?>
		</div>
	</section>
