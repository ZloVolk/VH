...
<?php 
	...
	homeland_slider_thumb(); // modify in custom-functions.php
	...
	if(empty($homeland_hide_three_cols)) : ?>
		...
		<section class="three-columns-block">
			<div class="inside clear">
				<?php 
					homeland_testimonials_small(); // modify in custom-functions.php
					homeland_featured_list(); // modify in custom-functions.php
