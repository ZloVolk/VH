...
if ($cats) {
    ...
    if ($related->have_posts()) {
        ...
        mk_similar_portfolio_html(__('Related Listings', 'mk_framework') , $width, $height, $related);
    }
    $post = $backup;
}
if (!$related_post_found) {
    ...
    $output = '';
    mk_similar_portfolio_html(__('Current Listings', 'mk_framework') , $width, $height, $recent);
}
wp_reset_postdata();
echo $output;
